"""
URL configuration for cryptocurrency_price_prediction project.
...
from users import views as user_views  # Assuming your app is called 'users'
from admins import views as admins
from django.contrib.staticfiles.urls import static
from django.contrib.staticfiles.urls import staticfiles_urlpatterns
from django.conf import settings
from cryptocurrency_price_prediction import views as mainView

urlpatterns = [
    # path('admin/', admin.site.urls),
    path('', mainView.index, name='index'),
    path("userRegistration/", mainView.userRegistration, name="userRegistration"),
    ...
    path("UserLoginCheck/", user_views.UserLoginCheck, name="UserLoginCheck"),
